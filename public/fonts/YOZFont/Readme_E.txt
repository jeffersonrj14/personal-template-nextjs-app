...
.1 Summary
    ...
    Standard kana (S), Educational (E).

    YOzakura series are "Small Kana" version.
...
..1-1 OpenType(otf)
         ...
         YOz N M b Pr6N/Pro
    YOzakura N M b Pr6N/Pro <-- Small Kana
             | | |     |
             | | |     +-> Pr6N: Adobe-Japan1-6, based on JIS X 0213:2004, 
             | | |         Pro:  Adobe-Japan1-4, based on JIS X 0208:1990
             | | +-> (None): Regular, b:Bold
             | +-> M: aijlx for Math, 
             |     X: block letters, XM: X&M
             +-> A: antique kana, C: cute kana, E: educational kana, 
                 N: new kana, S: standard
